<%@ Page Title="" Language="C#" MasterPageFile="~/Views/User/user.Master" AutoEventWireup="true" CodeBehind="UserAddBookings.aspx.cs" Inherits="GuestHouse.Views.User.UserAddBookings" %>
            ...
            $("#submitBtn").click(function (e) {
                ...
                if (booking.AssignRoomID && booking.FirstName && booking.BookingTypeID && booking.Address && booking.BookingFrom && booking.BookingTo && booking.NoOfMembers && booking.PhoneNo) {
                    $.ajax({
                        ...
                        url: 'UserAddBookings.aspx/SaveBookingDetails',
                ...
                <div class="col-md-9">
                    <div class="form-horizontal">
                        ...
                        <asp:UpdatePanel ID="UpdatePanelBT" runat="server">
                            <ContentTemplate>
                                <div class="form-row ml-2 mb-1 mt-3 col-md-9">
                                    <div class="col-md-3">
                        ...
                        <div class="form-row ml-2 mb-1 col-md-9">
                            <div class="col-md-4 mr-1">
                        ...
                        <div class="form-row ml-2 mb-1 col-md-9">
                            <div class="col-sm-offset-2 col-sm-10">
                                <asp:Button class="btn btn-primary ml-2 mt-4" ID="Bookings" runat="server" Text="Back" OnClientClick="javascript:window.location.href='UserBookings.aspx'; return false;"></asp:Button>
