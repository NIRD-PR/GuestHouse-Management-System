<%@ Page Title="" Language="C#" MasterPageFile="~/Views/User/user.Master" AutoEventWireup="true" CodeBehind="UserBookings.aspx.cs" Inherits="GuestHouse.Views.User.UserBookings" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                url: 'UserBookings.aspx/GetBookings',
                data: '{}',
    ...
    <main>
        <div class="container-fluid">
            ...
            <%--    <form role="form" id="Booking" action="#" method="post" runat="server" style="margin-left: 15px"> --%>
                    <asp:Button type="button" class="btn btn-primary" ID="addBooking" runat="server" PostBackUrl="~/Views/User/UserAddBookings.aspx" Text="New Booking"></asp:Button>
