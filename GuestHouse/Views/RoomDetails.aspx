<%@ Page Title="Room Details" Language="C#" MasterPageFile="~/Views/Dashboard.Master" AutoEventWireup="true" CodeBehind="RoomDetails.aspx.cs" Inherits="GuestHouse.Views.RoomDetails" %>
                                ...
                                <ItemTemplate>
                                    <tr <%# GetRowColor(DataBinder.Eval(Container.DataItem,"IsActive").ToString()) %>>
                                        ...
                                        <td>
                                            ...
                                            <asp:LinkButton runat="server" ID="ShowBlock" Text='<%#((bool) Eval("IsActive"))? "Block":"Unblock" %>' CommandArgument='<%# Eval("RoomID") +","+ Eval("IsActive") %>' OnClick="ShowBlock_Click" />
                                        </td>
                                        </td>
